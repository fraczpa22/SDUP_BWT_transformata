...
HD_PWD='D:/AGH_magisterskie/SDUP/Projekt/SDUP_BWT_transformata/BWT_cordic/BWT_cordic.runs/design_acc_cordic_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_acc_cordic_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_acc_cordic_ip_0_1.tcl
