...
EAStep vivado -log BWT_transform_with_Pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BWT_transform_with_Pipeline.tcl -notrace
