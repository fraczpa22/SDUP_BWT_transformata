...
HD_PWD='D:/AGH_magisterskie/SDUP/Projekt/BWT/BWT/BWT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BWT_transform.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BWT_transform.tcl -notrace
