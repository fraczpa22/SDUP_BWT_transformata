...
synth_design -top BWT_transform_with_Pipeline -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef BWT_transform_with_Pipeline.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file BWT_transform_with_Pipeline_utilization_synth.rpt -pb BWT_transform_with_Pipeline_utilization_synth.pb"
